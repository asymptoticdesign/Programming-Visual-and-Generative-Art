...
void restart(){
  ...
  for(int x=0;x<numX;x++){
     for(int y=0;y<numY;y++){
       ...
       cellMatrix[x][y].addNeighbor(cellArray[left][above]);
       cellMatrix[x][y].addNeighbor(cellArray[left][y]);
       cellMatrix[x][y].addNeighbor(cellArray[left][below]);
       cellMatrix[x][y].addNeighbor(cellArray[right][above]);
       cellMatrix[x][y].addNeighbor(cellArray[right][y]);
       cellMatrix[x][y].addNeighbor(cellArray[right][below]);
       cellMatrix[x][y].addNeighbor(cellArray[x][above]);
       cellMatrix[x][y].addNeighbor(cellArray[x][below]);
     }
  }
}
