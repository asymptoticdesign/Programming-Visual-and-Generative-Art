//  Title: Particle Emitter Example 1
//  Description: A simple particle emitter -- click and 3 particles spiral from the center,
//  modulated by Perlin noise
...
class Particle {
  ...
  void update() {
    noiseSeed += 0.01;
    radius += dR*noise(noiseSeed) - dR/4;
    theta += 5;
